...
resource "aws_route_table_association" "my_publicSubnetAssociation1" {
    ...
    depends_on = [aws_route_table.my_publicRouteTable1, aws_subnet.my_publicsubnet1]
}
...
resource "aws_route_table_association" "my_publicSubnetAssociation2" {
    ...
    depends_on = [aws_route_table.my_publicRouteTable1, aws_subnet.my_publicsubnet2]
}
